    ...
    public class ModuleCmdletBase : PSCmdlet
    {
        ...
        internal List<PSModuleInfo> GetModule(string[] names, bool all, bool refresh)
        {
            ...
            if (names != null)
            {
                ...
                {
                    if (ModuleIntrinsics.IsModuleNamePath(n))
                    {
                        modulePaths.Add(n);
                    }
                    else
        ...
        /// <summary>
        /// Resolves <paramref name="path"/> without error handling using the file system provider.
        /// </summary>
        ...
        ///     </list>
        /// </returns>
        /// <exception cref="RuntimeException">Thrown if path resolution isn't performed by the file system provider.</exception>
        internal static Collection<string> ResolveToFileSystemPathsThrowing(string path, ExecutionContext context, bool allowNonExistingPaths = false)
        {
            ...
            resolvedPaths = context.SessionState.Path.GetResolvedProviderPathFromPSPath(path,
